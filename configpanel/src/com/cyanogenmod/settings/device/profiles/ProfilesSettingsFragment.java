...
import com.cyanogenmod.settings.device.utils.SystemSettingSwitchBar;

import java.util.UUID;

public class ProfilesSettingsFragment extends SettingsPreferenceFragment implements SystemSettingSwitchBar.SwitchBarChangeCallback, Preference.OnPreferenceChangeListener {
    ...
    private SystemSettingSwitchBar mProfileEnabler;
    ...
    public void onStart() {
        super.onStart();
        final ProflesSettingsActivity activity = (ProflesSettingsActivity) getActivity();
        mProfileEnabler = new SystemSettingSwitchBar(activity, activity.getSwitchBar(), Settings.System.SYSTEM_PROFILES_ENABLED, true, this);
    }
