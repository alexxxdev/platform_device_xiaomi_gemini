...
import com.cyanogenmod.settings.device.utils.CustomDialogPreference;
import com.cyanogenmod.settings.device.utils.DialogCreatable;
import com.cyanogenmod.settings.device.utils.FloatingActionButton;
import com.cyanogenmod.settings.device.utils.LayoutPreference;
import com.cyanogenmod.settings.device.utils.PartsUpdater;
...
public class SettingsPreferenceFragment extends PreferenceFragment
    ...
    public void onResume() {
        ...
        if (args != null) {
            mPreferenceKey = args.getString(ProflesSettingsActivity.EXTRA_FRAGMENT_ARG_KEY);
    ...
    public final void finishPreferencePanel(Fragment caller, int resultCode, Intent data) {
        ((ProflesSettingsActivity)getActivity()).finishPreferencePanel(caller, resultCode, data);
    }
    ...
    protected Button getBackButton() {
        return (Button) ((ProflesSettingsActivity)getActivity()).getBackButton();
    }

    protected Button getNextButton() {
        return (Button) ((ProflesSettingsActivity)getActivity()).getNextButton();
    }

    protected void showButtonBar(boolean show) {
        ((ProflesSettingsActivity)getActivity()).showButtonBar(show);
    }
    ...
    public boolean startFragment(Fragment caller, String fragmentClass, int titleRes,
        ...
        if (activity instanceof ProflesSettingsActivity) {
            ProflesSettingsActivity sa = (ProflesSettingsActivity) activity;
            sa.startPreferencePanel(fragmentClass, extras, titleRes, null, caller, requestCode);
            return true;
        } else {
            Log.w(TAG,
                    "Parent isn't ProflesSettingsActivity! (name: " + fragmentClass + ")");
            return false;
        }
    }
