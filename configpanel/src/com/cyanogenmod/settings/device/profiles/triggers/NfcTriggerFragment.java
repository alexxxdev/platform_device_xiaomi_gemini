...
package com.cyanogenmod.settings.device.profiles.triggers;
...
import com.cyanogenmod.settings.device.profiles.NFCProfileTagCallback;
import com.cyanogenmod.settings.device.profiles.NFCProfileUtils;
import com.cyanogenmod.settings.device.profiles.ProfilesSettingsFragment;
import com.cyanogenmod.settings.device.profiles.ProflesSettingsActivity;
...
public class NfcTriggerFragment extends Fragment implements NFCProfileTagCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((ProflesSettingsActivity) getActivity()).setNfcProfileCallback(this);
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        ((ProflesSettingsActivity) getActivity()).setNfcProfileCallback(null);
    }
